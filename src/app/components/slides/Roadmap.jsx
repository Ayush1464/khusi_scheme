...
const roadmapPhases = [
  {
    ...
    milestones: [
      'Rural manufacturing setup',
      'Access to industrial resources',
      'SHG training programs',
      'Logistic automation setup',
      'Finance management system',
      'Online portal support',
    ],
    metrics: 'Initial Setup Phase',
  },
  {
    year: 'Year 2',
    period: '2027',
    ...
    milestones: [
      ...
      'Execution of Govt requirements',
      'Supply chain establishment',
      'SHG package forwarding',
      'Warehouse management',
    ],
    metrics: 'Scaling Production',
  },
  {
    year: 'Year 3',
    period: '2028',
    ...
    milestones: [
      ...
      'Smooth Govt execution',
      'SHG branding to private market',
    ],
    metrics: 'Efficiency Focus',
  },
  {
    year: 'Year 4',
    period: '2029',
    ...
    milestones: [
      'Manufacturing in other districts',
      'Supply to other state governments',
      'Supply chain expansion to other states',
    ],
    metrics: 'Inter-State Growth',
  },
  {
    year: 'Year 5',
    period: '2030',
    ...
    milestones: [
      'Breakeven achieved',
      'Profit generation for SHGs',
      'National level project rollout',
    ],
    metrics: 'Self-Sustained Model',
  },
];
